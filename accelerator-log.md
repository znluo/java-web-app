...
```json
{
  ...
  "repositoryPrefix" : "harbor.haas-428.pez.vmware.com/tap"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [sample-app-java->my-java-web-app]
┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].merge.transformations[0].sources[1].<combo>.transformations[1].transformations[1] (ReplaceText)
┃ ┃ ┃ ┗ ┗ ┗  Info Will replace [your-registry.io/project->harbor.haas-428.pez....(truncated)]
